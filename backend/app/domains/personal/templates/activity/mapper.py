...
def map_timeline_to_activity_item(
    ...
    *,
    ...
    return {
        ...
        "amount_label": base.get("amount_label"),
        "currency_code": currency,
        "category_code": category_code,
        "subcategory_code": subcategory_code,
        "category_label": base.get("category_label"),
        "subcategory_label": base.get("subcategory_label"),
        "mood_label": base.get("mood_label"),
        "icon": base.get("icon"),
        "color": base.get("color"),
        "impact_label": base.get("impact_label"),
        "impact_direction": base.get("impact_direction"),
        "source": "quick_add",
