"""Canonical Shared Living service — projection + activity driven."""
...
from app.domains.group.templates.shared_living.projection_helpers import relative_time_label
...
class SharedLivingService:
    ...
    def serialize_activity(item: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "icon": str(item.get("icon") or "home"),
