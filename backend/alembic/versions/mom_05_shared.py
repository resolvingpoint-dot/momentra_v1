"""005 Shared (Life360 + Circle) tables

Revision ID: mom_05_shared
Revises: mom_04_business

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_05_shared.up.sql`` / ``sql/mom_05_shared.down.sql`` files
...
revision = "mom_05_shared"
down_revision = "mom_04_business"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _run("mom_05_shared.up.sql", record=True)


def downgrade() -> None:
    _run("mom_05_shared.down.sql", record=False)
