"""007 Functions + Triggers

Revision ID: mom_07_functions
Revises: mom_06_views

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_07_functions.up.sql`` / ``sql/mom_07_functions.down.sql`` files
...
revision = "mom_07_functions"
down_revision = "mom_06_views"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _run("mom_07_functions.up.sql", record=True)


def downgrade() -> None:
    _run("mom_07_functions.down.sql", record=False)
