"""001 Core (extensions + users.user_id compatibility)

Revision ID: mom_01_core
Revises: a1b2c3d4e5f6

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_01_core.up.sql`` / ``sql/mom_01_core.down.sql`` files
...
def upgrade() -> None:
    _run("mom_01_core.up.sql", record=True)


def downgrade() -> None:
    _run("mom_01_core.down.sql", record=False)
