"""004 Business domain tables

Revision ID: mom_04_business
Revises: mom_03_group

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_04_business.up.sql`` / ``sql/mom_04_business.down.sql`` files
...
revision = "mom_04_business"
down_revision = "mom_03_group"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _run("mom_04_business.up.sql", record=True)


def downgrade() -> None:
    _run("mom_04_business.down.sql", record=False)
