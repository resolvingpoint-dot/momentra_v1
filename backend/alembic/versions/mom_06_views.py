...
Revision ID: mom_06_views
Revises: mom_05_shared

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_06_views.up.sql`` / ``sql/mom_06_views.down.sql`` files
...
revision = "mom_06_views"
down_revision = "mom_05_shared"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _run("mom_06_views.up.sql", record=True)


def downgrade() -> None:
    _run("mom_06_views.down.sql", record=False)
