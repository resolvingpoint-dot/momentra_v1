"""002 Personal domain tables/indexes/constraints

Revision ID: mom_02_personal
Revises: mom_01_core

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_02_personal.up.sql`` / ``sql/mom_02_personal.down.sql`` files
...
revision = "mom_02_personal"
down_revision = "mom_01_core"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _run("mom_02_personal.up.sql", record=True)


def downgrade() -> None:
    _run("mom_02_personal.down.sql", record=False)
