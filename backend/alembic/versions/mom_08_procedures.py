...
Revision ID: mom_08_procedures
Revises: mom_07_functions

Auto-generated from the Momentra SQL design documents. The SQL is preserved
verbatim in the sibling ``sql/mom_08_procedures.up.sql`` / ``sql/mom_08_procedures.down.sql`` files
...
revision = "mom_08_procedures"
down_revision = "mom_07_functions"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    _run("mom_08_procedures.up.sql", record=True)


def downgrade() -> None:
    _run("mom_08_procedures.down.sql", record=False)
