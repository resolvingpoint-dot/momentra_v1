import type { PersonalMemoryCopy } from "@/lib/personal/life_operations/memory/lifeOpsMemoryCopy";

export const relationshipsMemoryCopy: PersonalMemoryCopy = {
