...
export function LivingTypeSelect({
  profiles,
  selectedProfile,
  onSelectProfile,
  onContinue,
}: LivingTypeSelectProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold">Choose Living Type</h2>
        <p className="mt-2 text-sm opacity-80" style={{ color: colors.textSecondary }}>
          Select the type of shared living arrangement you want to create
        </p>
      </div>
