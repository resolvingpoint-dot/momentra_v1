...
import { Archive, Pause, Pencil, Play, Settings2, SlidersHorizontal } from "lucide-react";
import { useThemeTokens } from "@/components/theme/AppContextProvider";
import type { PersonalMomentManageContext } from "@/components/personal/shared/personalMomentRouting";

type PersonalMomentManageSheetProps = {
  open: boolean;
  context: PersonalMomentManageContext | null;
  onClose: () => void;
  onEditSetup: () => void;
...
export function PersonalMomentManageSheet({
  open,
  context,
  onClose,
  onEditSetup,
  ...
  onArchive,
  onComplete,
}: PersonalMomentManageSheetProps) {
